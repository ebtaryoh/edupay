  ...
  return (
    <div className="min-w-0 space-y-5 overflow-x-hidden pb-10 sm:space-y-6 xl:space-y-7">
      <div className="px-4 sm:px-6 xl:px-7 mt-6">
        <div className="min-h-[calc(100vh-140px)] min-w-0 rounded-[32px] bg-[#2F1FD9] px-6 py-6 md:px-10 md:py-8">
          ...
          <div className="mt-8 rounded-[40px] bg-[#D8D5F2] px-8 py-10 md:px-10 md:py-10">
            <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_1.1fr] xl:gap-16">
