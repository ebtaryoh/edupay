  ...
  return (
    <AdminPaymentsShell title="Payments" activeKey="manage-fees">
      <div className="flex min-h-full items-stretch">
        <section className="ml-auto flex min-h-[940px] w-full max-w-[450px] flex-col items-center bg-[#3A26F0] px-7 pb-10 pt-16 text-center shadow-[0_24px_55px_rgba(47,32,217,0.20)]">
          <img
            src={piggybankImg}
            alt="Piggy bank"
          ...
          <p className="mt-8 text-[18px] leading-8 text-white/75">
            Awesome!
            <br />
            Your new fee is up and running.
          </p>

          <button
            type="button"
            onClick={() => nav("/admin/dashboard/payments/fees")}
            className="mt-auto inline-flex h-[68px] w-full cursor-pointer items-center justify-center rounded-full bg-white text-[18px] font-semibold text-[#3A26F0] transition hover:brightness-95 active:scale-[0.99]"
          >
            View Fees
          </button>
        </section>
