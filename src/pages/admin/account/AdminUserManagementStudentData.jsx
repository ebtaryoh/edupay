...
const tabs = [
  { key: "personal", label: "Personal Information", to: "/admin/dashboard/account/user-management/students/student-1" },
  { key: "institution", label: "Institution", to: "/admin/dashboard/account/user-management/students/student-1?tab=institution" },
];
