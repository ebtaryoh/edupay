...
export default function AdminEditFeeDurationStart() {
      ...
      <div className="w-full max-w-[560px] pt-2">
        ...
        <div className="mt-16 flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-3 text-[18px] font-medium text-[#3827ED]">July 2025</p>
          </div>
        ...
        <div className="mt-16 border-b border-[#E7E9F2] pb-5">
          <p className="text-[18px] font-medium text-[#16171D]">Pick a start date</p>
        </div>
        ...
        <button
          type="button"
          onClick={() => nav("/admin/dashboard/payments/fees/1/edit/end-date")}
